...
Feel free to visit any one of them. You might find a nice to place to live or hang out.`,sublocations:{notowns:{displayName:"Sorry, No Towns Yet",menuName:"No Towns",description:`Sorry. Our new survival world recently started, so no towns have been added to
this page just yet. Check this place again soon and we will likely have some
hotspots for you to check out.`}}}},n={summary:{displayName:"Towns",menuName:"Summary",description:`<p>Want to live with other players? Find it too boring not having neighbors?<br>
Our survival map has towns that range from close community neighborhoods
connected by a single road to massive cities with distinct cultures and styles.</p>
<p>Towns usually accept any and all community members to live in them.<br>
However, residential approval should only be done at the discretion of
